...
- **Seen, not fixed:** no status bar message showed at that point in the TUI, "creating a Daytona sandbox…" and `R`'s "connecting to…" alike, though "stopping dt…" had shown earlier. Not specific to sandboxes; worth a look separately.
